...
local request = require("nemu.request")
...
function M.send_prompt_to_ai(prompt)
	...
	diff.init_diff(bufnr, start_line, end_line, selected_text_cache or "")

	request.request_completion(selected_text_cache, prompt)
end
